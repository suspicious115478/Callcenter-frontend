...
const EmployeeHelpDeskPage = () => {
    ...
    // The component assumes these are passed via navigation state
    ...
    const styles = {
        ...
        centeredContainer: { // FIX: New style for centering content
            maxWidth: '1400px',
            margin: '0 auto',
            padding: '0 32px',
        },
        ...
        callInfo: { // Prominent Caller ID box
            textAlign: 'right',
        ...
        contentGrid: {
            display: 'grid',
            gridTemplateColumns: '2.5fr 1fr', // FIX: Main column 2.5x wider than side column
            gap: '32px',
        },
        card: {
            backgroundColor: 'white',
        ...
        // Quick Action/Note Styles
        inputField: { // FIX: Added style for textarea
            width: '100%',
            minHeight: '200px',
            padding: '12px',
            borderRadius: '6px',
            ...
            marginBottom: '16px',
            resize: 'vertical',
            boxSizing: 'border-box', // Ensure padding doesn't push it out
        },
        saveButton: { // FIX: Added style for save button
            width: '100%',
            ...
            <div style={styles.mainContentArea}>
                <div style={styles.centeredContainer}>
                    ...
                    <div style={styles.contentGrid}>
                        ...
                        {/* Left Column: Dispatch Details & Action Buttons */}
