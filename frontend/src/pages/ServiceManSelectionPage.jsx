...
        
        // 🛑 FIX 1: Check if a serviceman is selected (Replaced alert() with setDispatchStatus)
...
        }
        ...
        // 🛑 FIX 2: Check for critical missing data fields (phoneNumber and ticketId)
        if (!phoneNumber) {
...
            
            // 💡 CONFIRMED: Included ticket_id and phone_number in the payload
            ticket_id: ticketId,
